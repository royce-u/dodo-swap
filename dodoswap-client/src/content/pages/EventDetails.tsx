...
//    }
    ...
    // console.log(typeof(hostInfo._id))
    console.log(props.user._id)
    console.log(hostIdNumber)
    //find
    // if (hostId == props.user.id){

    // }

    let attendeeDisplay = attendeeList.map((a:any) => {
        return(
            <p>{a.attendeeId.userName}</p>
        )
    })
            ...
            <Grid.Row>
                ...
                <Grid.Row stretched>
                    ...
                    <Message >
                        ...
                        <p>Attendees: {attendeeDisplay}</p>
                        {props.user._id  == hostIdNumber ? <p>This is your hosted event</p> : <Button onClick={handleJoin} color="blue">Join</Button>   }
                    </Message>
                    </Grid.Column>
                </Grid.Row>               
            </Grid>
